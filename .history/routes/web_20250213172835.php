...
Route::put('/user/update/{id}', [UserController::class, 'update'])->name('user_update'); // send user to edit page
Route::get('/user/list', [UserController::class, 'users'])->name('user_list');   // see users
Route::get('/user/profile/{id}', [UserController::class, 'profile'])->name('user_profile');
