...
Route::post('/ticket/complete/{id}', [TicketController::class, 'completeTicket'])->name('ticket_complete');
Route::post('/ticket/reject/{id}', [TicketController::class, 'rejectTicket'])->name('ticket_reject');