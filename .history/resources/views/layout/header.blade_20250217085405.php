...
<body>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('ticket_create')}}">Create Ticket</a>
                        <a class="collapse-item" href="{{ route('ticket_create')}}">Ticket List</a>
                        {{-- <a class="collapse-item" href="{{ route('ticket_list')}}">Ticket List</a> --}}
                    </div>
                </div>
            </li>
            ...
            @if (Auth::user()->r_id == 1)
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">CRUD:</h6>
                            <a class="collapse-item" href="{{ route('user_create')}}">Create User</a>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <script src="{{ asset('assets/js/js/sb-admin-2.min.js') }}"></script>
