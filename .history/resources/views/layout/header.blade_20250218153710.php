                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                <span class="badge badge-danger badge-counter">{{ $alerts['in_progress'] }}</span>
                            </a>
                            <!-- Dropdown - Alerts -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">t_control_no</div>
                                            <span>A new ticket has been created by f_name l_name.</span>
                                    </div>
                                </a>
                                <!-- In Progress -->
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">t_control_no</div>
                                            <span>Your ticket has been approved by f_name l_name.</span>
                                    </div>
                                </a>
                                <!-- For Evaluation -->
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">t_control_no</div>
                                            <span>The ticket t_control_no is pending for evaluation.</span>
                                    </div>
                                </a>
