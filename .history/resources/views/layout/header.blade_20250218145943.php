                            ...
                            function loadAlerts() {
                                fetch('{{ route("alerts") }}')
                                    ...
                                    .then(data => {
                                        ...
                                        // Update counter
                                        alertsCounter.textContent = data.total_count > 3 ? '3+' : data.total_count;
                                        ...
                                        data.alerts.forEach(alert => {
                                            const alertHTML = `
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <div class="mr-3">
                                                        <div class="icon-circle ${alert.template.bg_class}">
                                                            <i class="${alert.template.icon} text-white"></i>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <div class="small text-gray-500">${alert.t_control_no}</div>
                                                        <span>${alert.template.message}</span>
                                                    </div>
                                                </a>
                                            `;
