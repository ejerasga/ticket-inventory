                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            @foreach ($tickets as $ticket)
                                @if ($ticket->status == 0)
                                    <!-- For Approval -->
                                    <a class="dropdown-item d-flex align-items-center" href="{{ route('ticket_info', $ticket->t_id) }}">
                                        <div class="mr-3">
                                        ...
                                        <div>
                                            ...
                                            <span>A new ticket has been created by {{ $ticket->created_by->f_name }} {{ $ticket->created_by->l_name }}.</span>
                                        </div>
                                    </a>
                                @elseif ($ticket->status == 1)
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="{{ route('ticket_info', $ticket->t_id) }}">
                                        ...
                                        <div>
                                            <div class="small text-gray-500">{{ $ticket->t_control_no }}</div>
                                            <span>Your ticket has been approved by {{ $ticket->approved_by->f_name }} {{ $ticket->approved_by->l_name }}.</span>
                                        </div>
                                    </a>
                                @elseif ($ticket->status == 2)
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="{{ route('ticket_info', $ticket->t_id) }}">
                                        ...
                                        <div>
                                            <div class="small text-gray-500">{{ $ticket->t_control_no }}</div>
                                            <span>The ticket {{ $ticket->t_control_no }} is pending for evaluation.</span>
                                        </div>
                                    </a>
                                @endif
                            @endforeach
