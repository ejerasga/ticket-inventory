                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <div id="alertList">
                                    <p class="dropdown-item text-center small text-gray-500">No new alerts</p>
                                </div>
                        ...
                        document.addEventListener("DOMContentLoaded", function() {
                            fetch("{{ route('alerts') }}")
                                ...
                                .then(data => {
                                    ...
                                    alertList.innerHTML = "";
                                    alertCount.textContent = data.length > 0 ? data.length : "0";
                        
                                    if (data.length === 0) {
                                        alertList.innerHTML = `<p class="dropdown-item text-center small text-gray-500">No new alerts</p>`;
                                    } else {
                                        data.forEach(alert => {
                                            let alertItem = `
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span>A new ticket has been created by ${alert.f_name} ${alert.l_name}.</span>
                                                    </div>
                                                </a>`;
