                        ...
                        <div class="card-body">
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="f_fname" name="f_fname" type="text" placeholder="Enter your first name" value="{{ old('u_fname', $user->u_fname) }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="small mb-1" for="m_lname">Middle name</label>
                                    <input class="form-control" id="m_lname" name="m_lname" type="text" placeholder="Enter your middle name" value="{{ old('u_lname', $user->u_mname) }}">
                                </div>
                                <div class="col-md-4">
