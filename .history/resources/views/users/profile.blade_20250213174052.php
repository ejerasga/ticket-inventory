                        ...
                        <div class="card-body">
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="m_fname" name="u_fname" type="text" placeholder="Enter your first name" value="{{ old('u_fname', $user->u_fname) }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="small mb-1" for="l_fname">Middle name</label>
                                    <input class="form-control" id="l_fname" name="u_lname" type="text" placeholder="Enter your middle name" value="{{ old('m_lname', $user->m_lname) }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="small mb-1" for="l_fname">Last name</label>
                                    <input class="form-control" id="l_fname" name="u_lname" type="text" placeholder="Enter your last name" value="{{ old('u_lname', $user->u_lname) }}">
                                </div>
                            </div>
