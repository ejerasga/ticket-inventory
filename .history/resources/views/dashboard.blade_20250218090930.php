@extends('layout.header')
    ...
    <div class="container-fluid">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Average Resolution Time (Hours)</h6>
                </div>
                <div class="card-body">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var resolutionTimeChart = new Chart(resolutionCtx, {
                type: 'line',
                data: {
                    labels: [
                        @foreach($averageResolutionTimes as $time)
                            '{{ $time->month }}',
                        @endforeach
                    ],
                    datasets: [{
                        ...
                        data: [
                            @foreach($averageResolutionTimes as $time)
                                {{ round($time->avg_resolution_time, 2) }},
                            @endforeach
                        ],
                        lineTension: 0.3,
