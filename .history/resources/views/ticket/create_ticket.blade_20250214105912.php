                ...
                <form action="{{ route('user_save') }}" method="POST">
                    ...
                    <div class="col-xl-12">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label class="small mb-1" for="u_username">What Department?</label>
                                <input class="form-control" id="u_username" name="u_username" type="text" placeholder="Enter the department" value="">
                            </div>
