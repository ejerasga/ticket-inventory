    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Evaluate Ticket #{{ $ticket->t_control_no }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('ticket_evaluate_save', $ticket->t_id) }}" method="POST">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <div class="radio">
                            @for ($i = 5; $i >= 1; $i--)
                            <input id="personnells-quality-{{ $i }}" type="radio" name="personnells_quality" value="{{ $i }}" required />
