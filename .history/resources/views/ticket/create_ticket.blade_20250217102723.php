                        ...
                        <div class="card-body">
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="f_name" name="f_name" type="text" placeholder="Enter your first name" value="">
                                </div>
                                <div class="col-md-6">
                                    <label class="small mb-1" for="l_name">Last name</label>
                                    <input class="form-control" id="l_name" name="l_name" type="text" placeholder="Enter your last name" value="">
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    <label class="small mb-1" for="date_needed">Date Needed</label>
                                    <input class="form-control" id="date_needed" name="date_needed" type="date" value="">
                                </div>
                                <div class="col-md-6">
                                    <label class="small mb-1" for="time_needed">Time Needed</label>
                                    <input class="form-control" id="time_needed" name="time_needed" type="time" value="">
                                </div>
                            </div>
                            <div class="mb-3">
