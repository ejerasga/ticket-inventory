@extends('layout.header')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Prevent row click when clicking the Assign button
            document.querySelectorAll('[data-target^="#assignModal"]').forEach(button => {
                button.addEventListener('click', function(e) {
                    e.stopPropagation(); // Stop the click from reaching the row
                });
            });

            // Optional: Handle row click excluding buttons
            document.querySelectorAll('tr[data-toggle="modal"]').forEach(row => {
                row.addEventListener('click', function(e) {
                    // Check if the click was on a button or its child
