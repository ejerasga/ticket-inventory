                    ...
                    <div class="col-xl-12">
                        <div class="card-body">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    <label class="small mb-1" for="">What Department?</label>
                                    <input class="form-control" id="" name="" type="text" placeholder="Enter your department" value="">
                                </div>
                            </div>
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="" name="date" type="date" value="">
                                </div>
                                <div class="col-md-6">
                                    <label class="small mb-1" for="time">Time Needed</label>
