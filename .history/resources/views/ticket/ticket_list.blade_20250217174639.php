                            ...
                            @foreach ($tickets as $ticket)
                                ...
                                @if (Auth::user()->r_id == 1)
                                    <td style="text-align: center;">
                                        <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#assignModal{{ $ticket->t_control_no }}" onclick="event.stopPropagation();">Assign</button>
                                        <a href="#" class="btn btn-sm btn-danger" onclick="event.stopPropagation();">Reject</a>
                                    </td>
                                @endif
                            </tr>
                                    @if (Auth::user()->r_id == 1 || Auth::user()->r_id == 2)
...
<script>
    // Stops event propagation for buttons within table rows
    document.querySelectorAll('button, a.btn-sm').forEach(element => {
...
@endsection
    ...
    @endsection
/******  83d1b029-2e50-4a8b-9800-90bad1259c40  *******/