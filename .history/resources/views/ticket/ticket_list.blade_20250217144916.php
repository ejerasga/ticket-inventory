...
/*************  ✨ Codeium Command 🌟  *************/
                        <tbody>
                            ...
                            <!-- Assign Modal -->
                            <div class="modal fade" id="assignModal{{ $ticket->t_control_no }}" tabindex="-1" role="dialog" aria-labelledby="assignModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('assign_ticket', ['ticket_id' => $ticket->t_control_no]) }}" method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="userSelect">Select Admin</label>
