...
class TicketController extends Controller {
    ...
    public function tickets()
    {
        ...
        return view('ticket.ticket_list', compact('tickets', 'adminUsers', 'alerts'));
    }
    ...
    {
        $alerts = [];
        $alerts['in_progress'] = Ticket::where('status', 1)->count();
        $alerts['for_evaluation'] = Ticket::where('status', 2)->count();
        $alerts['rejected'] = Ticket::where('status', 3)->count(); 
