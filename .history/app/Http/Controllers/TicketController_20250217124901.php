...
class TicketController extends Controller {
    public function index()
    {
        ...
        // Get the ticket counts for the authenticated user
        $counts = $this->getIndexCounts();

        // Pass the counts to the view
        return view('ticket.create_ticket', compact('services', 'locations', 'departments', 'counts'));
    }
    ...
    public function getIndexCounts()
    {
        ...
        return view('ticket.create_ticket', compact(
            'ticketCount', 'pendingTicketCount', 'inProgressTicketCount', 'completedTicketCount'
        ));
    }
