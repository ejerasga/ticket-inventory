...
class TicketController extends Controller {
    ...
    public function store(Request $request) {
        $request->validate([
            's_id' => 'required|exists:services,s_id', // validate if the service id exists in the database
            'l_id' => 'required|exists:locations,l_id', // validate if the location id exists in the database
            'd_id' => 'required|exists:departments,d_id', // validate if the department id exists in the database
            'f_name' => 'required',
            'l_name' => 'required',
