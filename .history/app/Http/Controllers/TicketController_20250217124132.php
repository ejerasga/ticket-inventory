...
class TicketController extends Controller {
    ...
    getIndexCounts() {
        $user = Auth::user();
        $ticketCount = Ticket::where('req_by', $user->u_id)->count();
        $pendingTicketCount = Ticket::where('req_by', $user->u_id)->where('t_status', 'Pending')->count();
        $inProgressTicketCount = Ticket::where('req_by', $user->u_id)->where('t_status', 'In Progress')->count();
        $completedTicketCount = Ticket::where('req_by', $user->u_id)->where('t_status', 'Completed')->count();
        return compact('ticketCount', 'pendingTicketCount', 'inProgressTicketCount', 'completedTicketCount');
