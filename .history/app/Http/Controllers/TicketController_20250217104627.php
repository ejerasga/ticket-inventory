...
class TicketController extends Controller {
    ...
    public function store(Request $request) {
        $request->validate([
            's_id' => 'required', 
            'l_id' => 'required', // Fixing: should be l_id, not located_at
        ...
        $ticket->located_at = $request->input('l_id'); // Ensure correct field mapping
        ...
        // Save the ticket first to generate the ID
        $ticket->save();
    
        // Now update the t_control_no field with the generated ticket ID
