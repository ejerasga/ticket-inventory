...
class TicketController extends Controller {
    ...
    public function getIndexCounts() {
        ...
        $inProgressTicketCount = Ticket::where('req_by', $user->u_id)->where('status', 'In Progress')->count();
        $completedTicketCount = Ticket::where('req_by', $user->u_id)->where('status', 'Completed')->count();
